...
import "../style/RestaurantRegisterAndLogin.css";

function RestaurantRegisterAndLogin() {
  ...
  return (
    <div className="restaurant-register-login-container">
      ...
      <CustomModal className="modal" isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        {isToRegister !== null && (
          <div className="restaurant-register-login-container">
                  ...
                  <div className="monday-container">
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.monday.open}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                    ...
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.monday.close}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                  ...
                  <div className="tuesday-container">
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.tuesday.open}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                    ...
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.tuesday.close}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                  ...
                  <div className="wednesday-container">
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.wednesday.open}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                    ...
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.wednesday.close}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                  ...
                  <div className="thursday-container">
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.thursday.open}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                    ...
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.thursday.close}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                  ...
                  <div className="friday-container">
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.friday.open}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                    ...
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.friday.close}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                  ...
                  <div className="saturday-container">
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.saturday.open}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                    ...
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.saturday.close}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                  ...
                  <div className="sunday-container">
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.sunday.open}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
                    ...
                    <label className="form-label">
                      ...
                      <input
                        ...
                        value={loginInputs.basicInfo.openAndCloseHours.sunday.close}
                        onChange={handleChange}
                        required
                        className="form-input"
                      />
...
export default RestaurantRegisterAndLogin;
